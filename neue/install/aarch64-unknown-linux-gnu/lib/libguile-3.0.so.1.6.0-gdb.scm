...
(set! %load-path
  (cons "/usr/skyhammer/neue/install/aarch64-unknown-linux-gnu/share/guile/3.0" %load-path))
(set! %load-compiled-path
  (cons "/usr/skyhammer/neue/install/aarch64-unknown-linux-gnu/lib/guile/3.0/site-ccache" %load-compiled-path))
