...
"aarch64-linux-thread-multi-6.5.0-1009-raspi" or
	die "Errno architecture (aarch64-linux-thread-multi-6.5.0-1009-raspi) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
