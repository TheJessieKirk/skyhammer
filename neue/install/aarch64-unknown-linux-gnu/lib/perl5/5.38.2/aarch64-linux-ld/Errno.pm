...
"aarch64-linux-ld-thread-multi-6.5.0-1008-raspi" or
	die "Errno architecture (aarch64-linux-ld-thread-multi-6.5.0-1008-raspi) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
