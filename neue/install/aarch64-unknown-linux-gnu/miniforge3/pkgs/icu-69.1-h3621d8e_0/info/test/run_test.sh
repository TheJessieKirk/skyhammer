...
test -f $PREFIX/lib/libicudata.so.69.1
test -f $PREFIX/lib/libicui18n.a
test -f $PREFIX/lib/libicui18n.so.69.1
test -f $PREFIX/lib/libicuio.a
test -f $PREFIX/lib/libicuio.so.69.1
test -f $PREFIX/lib/libicutest.a
test -f $PREFIX/lib/libicutest.so.69.1
test -f $PREFIX/lib/libicutu.a
test -f $PREFIX/lib/libicutu.so.69.1
test -f $PREFIX/lib/libicuuc.a
test -f $PREFIX/lib/libicuuc.so.69.1
genbrk --help
gencfu --help
gencnval --help
gendict --help
