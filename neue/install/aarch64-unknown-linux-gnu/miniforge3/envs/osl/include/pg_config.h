...
#define CONFIGURE_ARGS " '--prefix=/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl' '--with-readline' '--with-libraries=/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib' '--with-includes=/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/include' '--with-openssl' '--with-uuid=e2fs' '--with-libxml' '--with-libxslt' '--with-gssapi' '--with-system-tzdata=/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/share/zoneinfo' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=aarch64-conda-linux-gnu' 'CC=aarch64-conda-linux-gnu-cc' 'CFLAGS=-ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe -isystem /media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1689215597015/work=/usr/local/src/conda/postgresql-split-14.5 -fdebug-prefix-map=/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--allow-shlib-undefined -Wl,-rpath,/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib -Wl,-rpath-link,/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib -L/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/include' 'CXX=aarch64-conda-linux-gnu-c++' 'CXXFLAGS=-fvisibility-inlines-hidden -fmessage-length=0 -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe -isystem /media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1689215597015/work=/usr/local/src/conda/postgresql-split-14.5 -fdebug-prefix-map=/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl=/usr/local/src/conda-prefix' 'CPP=/home/conda/feedstock_root/build_artifacts/postgresql-split_1689215597015/_build_env/bin/aarch64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 14.5 on aarch64-conda-linux-gnu, compiled by aarch64-conda-linux-gnu-cc (conda-forge gcc 12.3.0-0) 12.3.0, 64-bit"
