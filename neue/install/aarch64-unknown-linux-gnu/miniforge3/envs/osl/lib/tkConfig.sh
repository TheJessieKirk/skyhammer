...
# installed.
TK_PREFIX='/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/include'
...
# compiled.
TK_SRC_DIR='/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/media/ssd/skyhammer/neue/install/aarch64-unknown-linux-gnu/miniforge3/envs/osl/lib/libtkstub8.6.a'
