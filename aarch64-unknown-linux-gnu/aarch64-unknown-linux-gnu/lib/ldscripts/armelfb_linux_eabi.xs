...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("/opt/skyhammer/aarch64-unknown-linux-gnu/aarch64-unknown-linux-gnu/lib"); SEARCH_DIR("/opt/skyhammer/aarch64-unknown-linux-gnu/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
