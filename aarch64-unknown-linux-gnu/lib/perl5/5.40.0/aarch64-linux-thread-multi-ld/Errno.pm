...
"aarch64\-linux\-thread\-multi\-ld-6\.11\.0\-1004\-raspi" or
	die "Errno architecture (aarch64\-linux\-thread\-multi\-ld-6\.11\.0\-1004\-raspi) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
