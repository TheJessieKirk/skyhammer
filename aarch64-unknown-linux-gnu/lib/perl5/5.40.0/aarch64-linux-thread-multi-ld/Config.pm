...
tie %Config, 'Config', {
    archlibexp => '/opt/skyhammer/aarch64-unknown-linux-gnu/lib/perl5/5.40.0/aarch64-linux-thread-multi-ld',
    ...
    osname => 'linux',
    osvers => '6.11.0-1004-raspi',
    path_sep => ':',
    privlibexp => '/opt/skyhammer/aarch64-unknown-linux-gnu/lib/perl5/5.40.0',
    scriptdir => '/opt/skyhammer/aarch64-unknown-linux-gnu/bin',
    sitearchexp => '/opt/skyhammer/aarch64-unknown-linux-gnu/lib/perl5/site_perl/5.40.0/aarch64-linux-thread-multi-ld',
    sitelibexp => '/opt/skyhammer/aarch64-unknown-linux-gnu/lib/perl5/site_perl/5.40.0',
    so => 'so',
    useithreads => 'define',
